...
import { boxBg, boxBgLines } from "../tools/common.ts";
import { renderBoxedMessageBlock } from "./boxed-message-block.ts";

const PATCH_FLAG = "__piUiCoreMessageBlocksPatched__";
