...
const RENDERED_FLAG = Symbol("__piUiDefaultBadge_rendered__");
const BOXED_FALLBACK_FLAG = Symbol("__piUiDefaultBadge_boxedFallback__");
const EXECUTION_STARTED_AT_FLAG = Symbol("__piUiDefaultBadge_executionStartedAt__");
