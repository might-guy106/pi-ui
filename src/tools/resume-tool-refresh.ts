const PATCHED = Symbol.for("pi-ui.resume-tool-refresh.patched");
const RUNTIME_STATE = Symbol.for("pi-ui.resume-tool-refresh.runtime-state");
const PENDING_TIMER = Symbol.for("pi-ui.resume-tool-refresh.pending-timer");
const VIRTUALIZED_CHAT_STATE = Symbol.for("pi-ui.virtualized-chat.state");
