...
const PATCHED = Symbol.for("pi-ui.footer-stats.patched");
const ORIGINAL_RENDER = Symbol.for("pi-ui.footer-stats.original-render");
const FOOTER_STATE = Symbol.for("pi-ui.footer-stats.state");
